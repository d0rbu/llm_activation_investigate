...
from transformers.models.llama.modeling_llama import logger, repeat_kv, apply_rotary_pos_emb
    ...
    def attn_reuse_attn_forward(
        ...
        **kwargs,
        ...
        if self.config.pretraining_tp > 1:
            ...
            query_states = th.cat(query_states, dim=-1)

            key_states = [F.linear(hidden_states, key_slices[i]) for i in range(self.config.pretraining_tp)]
            key_states = th.cat(key_states, dim=-1)

            value_states = [F.linear(hidden_states, value_slices[i]) for i in range(self.config.pretraining_tp)]
            value_states = th.cat(value_states, dim=-1)
        ...
        attn_output = th.matmul(attn_weights, value_states)
...
def convert_to_reuse_attn_mistral(
    ...
    **kwargs,
    ...
    def attn_reuse_attn_forward(
        ...
        **kwargs,
        ...
        # attn_weights = th.matmul(query_states, key_states.transpose(2, 3)) / math.sqrt(self.head_dim)
